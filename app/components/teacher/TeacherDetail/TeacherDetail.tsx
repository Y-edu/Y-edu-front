...
import { TeacherAllDetailsResponse } from "@/actions/get-teacher-all-detail";

import SelectBtn from "./SelectBtn";

interface TeacherDetailProps {
  data: TeacherAllDetailsResponse;
}

export default function TeacherDetail({ data }: TeacherDetailProps) {
  return (
