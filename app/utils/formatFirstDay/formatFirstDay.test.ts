...
describe("formatFirstDay 유틸 함수 테스트", () => {
  describe("convertToFirstDay", () => {
    test("Date와 시간 문자열을 FirstDay 객체로 변환한다", () => {
  ...
  describe("formatFirstDayToDateString", () => {
    test("FirstDay 객체를 날짜와 시간 문자열로 변환한다", () => {
      const firstDay = {
        year: 2024,
        month: "1월",
        day: "15일 (월)",
